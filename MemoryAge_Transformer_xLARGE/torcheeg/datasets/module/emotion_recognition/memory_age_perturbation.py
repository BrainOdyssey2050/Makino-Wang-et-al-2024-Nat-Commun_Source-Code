...
from ..base_dataset_perturbation import BaseDataset_perturbation


class MemoryAgeDataset_perturbation(BaseDataset_perturbation):
    r'''
    Args:
    ...
    def __init__(self,
                 ...
                 perturbation_channel: int = 0,
                 perturbation_freq: list = []):
    ...
    def _load_data(file: Any = None,
        ...
        perturbation_channel = kwargs.get('perturbation_channel') # 0, 1, 2
        perturbation_freq = kwargs.get('perturbation_freq')       # [6,12], [20,30], [30,50], [60,90]
        ...
        # define a bandstop filter for all the samples
        #                   order  Wn(bandstop)                                type       fs
        b, a = signal.butter(2, [perturbation_freq[0], perturbation_freq[1]], 'bandstop', fs=1600)
        ...
        for segment_id in range(len(samples)):
            ...
            chunk[perturbation_channel] = signal.filtfilt(b, a, chunk[perturbation_channel,:], axis=0)
