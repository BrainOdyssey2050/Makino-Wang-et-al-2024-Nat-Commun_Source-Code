...
class BaseDataset_perturbation(Dataset):
    ...
    def __init__(self,
        ...
        #perturbation_channel = kwargs.get('perturbation_channel')
        #perturbation_freq = kwargs.get('perturbation_freq')
    ...
    def __copy__(self) -> 'BaseDataset_perturbation':
        cls = self.__class__
